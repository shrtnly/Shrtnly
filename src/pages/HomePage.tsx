...
const HomePage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 dark:from-slate-900 dark:to-slate-800 transition-colors duration-theme">
      <SkipLinks />
...
<div className="bg-gradient-to-r from-blue-600 to-purple-600 dark:from-blue-700 dark:to-purple-700 rounded-2xl p-6 sm:p-8 text-white text-center shadow-lg mb-8 sm:mb-12 transition-colors duration-theme">
    ...
    <li>Track clicks and boost social media engagement with detailed analytics</li>
          ...
          <div className="mb-16">
            <div className="text-center mb-12">
              <h2 className="text-2xl sm:text-3xl font-bold text-text-primary mb-4">Why Choose Shrtnly for URL Shortening?</h2>
            ...
            <div className="grid gap-6 sm:gap-8 sm:grid-cols-2 lg:grid-cols-3">
              <div className="bg-surface-primary rounded-xl shadow-lg p-4 sm:p-6 hover:shadow-xl transition-all duration-theme">
                <div className="flex items-center gap-3 mb-4">
                  <div className="p-3 bg-blue-100 rounded-lg">
                    <Zap className="w-6 h-6 text-blue-600" />
                  </div>
                  <h3 className="text-lg sm:text-xl font-semibold text-text-primary">Create Custom Short Links</h3>
                </div>
              ...
              <div className="bg-surface-primary rounded-xl shadow-lg p-4 sm:p-6 hover:shadow-xl transition-all duration-theme">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <h3 className="text-lg sm:text-xl font-semibold text-text-primary">Instant QR Code Generator</h3>
                </div>
                <p className="text-sm sm:text-base text-text-secondary">
              ...
              <div className="bg-surface-primary rounded-xl shadow-lg p-4 sm:p-6 hover:shadow-xl transition-all duration-theme">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <h3 className="text-lg sm:text-xl font-semibold text-text-primary">Advanced Click Analytics</h3>
                </div>
                <p className="text-sm sm:text-base text-text-secondary">
              ...
              <div className="bg-surface-primary rounded-xl shadow-lg p-4 sm:p-6 hover:shadow-xl transition-all duration-theme">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <h3 className="text-lg sm:text-xl font-semibold text-text-primary">Safe Link Previews</h3>
                </div>
                <p className="text-sm sm:text-base text-text-secondary">
              ...
              <div className="bg-surface-primary rounded-xl shadow-lg p-4 sm:p-6 hover:shadow-xl transition-all duration-theme">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <h3 className="text-lg sm:text-xl font-semibold text-text-primary">Start Without Registration</h3>
                </div>
                <p className="text-sm sm:text-base text-text-secondary">
              ...
              <div className="bg-surface-primary rounded-xl shadow-lg p-4 sm:p-6 hover:shadow-xl transition-all duration-theme">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <h3 className="text-lg sm:text-xl font-semibold text-text-primary">Fully Accessible Design</h3>
                </div>
                <p className="text-sm sm:text-base text-text-secondary">
          ...
          <div className="mb-16">
            <div className="text-center mb-12">
              <h2 className="text-2xl sm:text-3xl font-bold text-text-primary mb-4">How to Create Short URLs in 4 Simple Steps</h2>
              <p className="text-base sm:text-lg text-text-secondary max-w-2xl mx-auto px-4">
            ...
            <div className="grid gap-6 sm:gap-8 sm:grid-cols-2 lg:grid-cols-4">
              <div className="text-center">
                <div className="relative mb-6">
                  ...
                  <div className="hidden lg:block absolute top-8 left-full w-full h-0.5 bg-blue-200 dark:bg-blue-800 -translate-y-1/2"></div>
                </div>
                <h3 className="text-lg sm:text-xl font-semibold text-text-primary mb-3">Enter Your Long URL</h3>
                <p className="text-sm sm:text-base text-text-secondary">
              ...
              <div className="text-center">
                <div className="relative mb-6">
                  ...
                  <div className="hidden lg:block absolute top-8 left-full w-full h-0.5 bg-green-200 dark:bg-green-800 -translate-y-1/2"></div>
                </div>
                <h3 className="text-lg sm:text-xl font-semibold text-text-primary mb-3">Customize Your Link</h3>
                <p className="text-sm sm:text-base text-text-secondary">
              ...
              <div className="text-center">
                <div className="relative mb-6">
                  ...
                  <div className="hidden lg:block absolute top-8 left-full w-full h-0.5 bg-purple-200 dark:bg-purple-800 -translate-y-1/2"></div>
                </div>
                <h3 className="text-lg sm:text-xl font-semibold text-text-primary mb-3">Generate Short Link</h3>
                <p className="text-sm sm:text-base text-text-secondary">
              ...
              <div className="text-center">
                ...
                <h3 className="text-lg sm:text-xl font-semibold text-text-primary mb-3">Share and Monitor</h3>
                <p className="text-sm sm:text-base text-text-secondary">
          ...
          {/* Call to Action */}
          <div className="bg-gradient-to-r from-blue-600 to-purple-600 dark:from-blue-700 dark:to-purple-700 rounded-2xl p-6 sm:p-8 text-center text-white transition-colors duration-theme">
